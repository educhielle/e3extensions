...
or1k-musl-linux-g++ -c -Wall -O2 -std=c++14 -fno-strict-aliasing -fPIC $src_unumber/unumberg.cpp -o $obj_unumber/unumberg_or1k.o
or1k-musl-linux-gcc -c -Wall -O2 -fPIC $src_unumber/cunmber_4096_m.c -o $obj_unumber/cunmber_4096_m_or1k.o
or1k-musl-linux-g++ -c -Wall -O2 -std=c++14 -fno-strict-aliasing -fPIC $src_unumber/ma_invert_m.cpp -o $obj_unumber/ma_invert_m_or1k.o
echo "done"
