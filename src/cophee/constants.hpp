unsigned GPCFG_HOSTIRQ_PAD_CTL 	= 0x40020018 ;
unsigned GPCFG_N_ADDR0         	= 0x40029000 ;
unsigned GPCFG_NSQ_ADDR0       	= 0x40029100 ;
unsigned GPCFG_FKF_ADDR0       	= 0x40029200 ;
unsigned GPCFG_CLCTL_ADDR      	= 0x40028004 ;
unsigned GPCFG_CLEQCTL2        	= 0x400200A8 ;
unsigned GPCFG_RAND0_ADDR0     	= 0x40029600 ;
unsigned GPCFG_RAND1_ADDR0     	= 0x40029680 ;
unsigned GPCFG_CLSTATUS_ADDR	= 0x40028008 ;
unsigned GPCFG_CLCTLP_ADDR 		= 0x40028000 ;
unsigned GPCFG_GPIO0_PAD_CTL   	= 0x4002001C ;

unsigned GPCFG_UARTM_BAUD_CTL   = 0x40020044 ;

unsigned GPCFG_ARGA_ADDR0  		= 0x40029300 ;
unsigned GPCFG_ARGB_ADDR0  		= 0x40029400 ;

unsigned GPCFG_MUL_ADDR0   		= 0x40029800 ;
unsigned GPCFG_EXP_ADDR0   		= 0x40029900 ;
unsigned GPCFG_INV_ADDR0   		= 0x40029A00 ;
unsigned GPCFG_RES_ADDR0   		= 0x40029700 ;

unsigned cleq_ctl  			= 0XC00027FD ;
unsigned cleq_ctl2 			= 0X000003FE ;
unsigned cleq_N [] 			= { 0X54330594, 0XCAEEF922, 0X52AEF179, 0XC2023770, 0X5F05CF9D, 0X412A3B26, 0X506E5692, 0X9CA7CD61,
...
unsigned cleq_NSQ [] 		= { 0X1BB185D4, 0XDE94D51E, 0X64D92754, 0XE64C536F, 0XC557EFCF, 0X6D28ACE0, 0XF2F972B4, 0XE2520943,
...
unsigned cleq_rand0 [] 		= { 0X011C3DC4, 0XD6F8CA7A, 0X46373E00, 0XC0287C76, 0X7D0F26BB, 0X6DAB6C0B, 0XA9D6C907, 0X5D2971F4,
...
unsigned cleq_rand1 [] 		= { 0X04345AA8, 0XAB1006A3, 0XEF517A70, 0XAFA72C4E, 0X38609BD3, 0XC9F9B026, 0X5A7DDA5B, 0X053EB211,
...
unsigned cleq_fkf [] 		= { 0X14124889, 0XD7B2F250, 0X8B3CF434, 0X153A43F6, 0X85C5992D, 0XA3DE651B, 0XF9AD4EB4, 0XC8A68780,
